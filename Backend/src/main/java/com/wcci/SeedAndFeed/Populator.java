...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception{
        ...
        Plant green_beans = new Plant("Green Beans", 55, "18-30", "Full", -999, "./img/bush_beans_photo.jpg","Balance your soil pH. Green beans prefer a slightly acidic soil with a pH of around 6.0. Provide sun. Green bean plants need six to eight hours of full sun per day.");
        ...
        Plant sugar_snap_peas = new Plant("Sugar Snap Peas", 70, "48-72", "Full", -999, "./img/sugar_snap_peas_photo.png", "Peas need about an inch of water a week. When watering, avoid wetting the foliage if possible to avoid disease. Peas will reach maturity in 50 – 70 days depending on the variety and growing conditions");
